...
//        İşleme başlarken bir önceki değer olmadığı için bu değer identity parametresinde tanımlanmaktadır.
    ...
    public static void karakterSayiYedidenBuyuk(List<String> yemek) {
       ...
       }else System.out.println("Bazi elemanlar 7den buyuk uzunluga sahip");
       //lambda Expression
        System.out.println(yemek.stream().allMatch(t->t.length()<=7)
                ? "list elemanlari 7 ve daha az harften olusmus"
                : "Bazi elemanlar 7den buyuk uzunluga sahip");
    ...
    public static void xIleBitenEleman(List<String> yemek) {
        yemek.stream().filter(t->t.endsWith("a")).forEach(Methodlarim::yazdir);
    }
    ...
    public static void karkterEnFazla(List<String> yemek) {
      ...
      Stream<String>sonisim = yemek.stream()
              ...
              .limit(1);
      System.out.println("karakteri en fazla olan : "+Arrays.toString(sonisim.toArray()));
    }
    /*
